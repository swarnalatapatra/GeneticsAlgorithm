...
%strsplit2 Split string into pieces.
%
%   strsplit2(SPLITSTR, STR, OPTION) splits the string STR at every occurrence
%   of SPLITSTR and returns the result as a cell array of strings.  By default,
%   SPLITSTR is not included in the output.
%
%   strsplit2(SPLITSTR, STR, OPTION) can be used to control how SPLITSTR is
